...
def load_dataset_from_config(train_set="baseline", config_path=None, train_path="train.csv", test_path="test.csv", train_size=None):
...
def main():
    ...
    parser.add_argument(
        "--model_output_dir", type=str, default="training_outputs/transfer/"
    )
    parser.add_argument(
        "--eval_output_dir", type=str, default="evaluation_results/transfer/"
    )
